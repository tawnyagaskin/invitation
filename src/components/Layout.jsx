    ...
    <div className="relative min-h-screen w-full bg-gray-100/40 flex items-center justify-center">
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={toggleMusic}
          className="fixed top-4 right-4 z-50 bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-lg border border-sky-100/50"
        >
          {isPlaying ? (
            <div className="relative">
              <PauseCircle className="w-6 h-6 text-sky-500" />
